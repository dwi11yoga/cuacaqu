...
export default function App() {
  ...
  const fetchAPI = async () => {
    const response = await axios.get("http://localhost:8080/weather-today");
  ...
  // fungsi mengetahui cuaca
  function weatherCodeConversion(weather, hour) {
  ...
  const weatherCondition = weatherCodeConversion(
  ...
  const getWeatherBackground = weatherBackground(
    weather.today ? weather.today.weather : ""
  );
  ...
  return (
    <div className="grid grid-cols-5 gap-4 h-screen p-[5vh]">
      ...
      <div className="col-span-2 h-[100vh-10vh] rounded-xl overflow-hidden relative">
        ...
        {/* info cuaca */}
        <div className="absolute bottom-7 left-7 pr-7 text-white space-y-4">
          ...
          <div className="italic pr-10">
            {randomInstruction(weather.today ? weather.today.weather : 0)}
          </div>

          <div className="flex justify-between">
            <div className="">
              {weather.metadata ? weather.metadata.shortLocation : "..."}
            </div>
            <div className="">
              <Clock />
            </div>
      ...
      <div className="col-span-3 grid grid-cols-2 gap-3 overflow-y-scroll">
        {/* detail cuaca */}
        <div className="h-full space-y-3 border border-neutral-200 p-4 rounded-md">
          ...
          <div className="divide-y divide-solid">
            ...
            <div className="flex justify-between items-center pb-2">
              ...
              <div className="">
                <span className="font-bold text-xl">
                  {weather.today ? weather.today.humidity : "..."}
                </span>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="">
                <span className="font-bold text-xl">
                  {weather.today ? weather.today.precipitation : "..."}
                </span>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="">
                <span className="font-bold text-xl">
                  {weather.today ? weather.today.cloudCover : "..."}
                </span>
                <span className="text-sm">%</span>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="">
                <span className="font-bold text-xl">
                  {weather.today ? weather.today.visibility : "..."}
                </span>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="">
                <span className="font-bold text-xl">
                  {weather.today ? weather.today.windSpeed : "..."}
                </span>
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="font-bold text-xl">
                {weather.today ? weather.today.windDir : "..."}
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="h-full space-y-1 border border-neutral-200 p-4 rounded-md">
          <div className="font-semibold text-lg">Upcoming hours</div>
          <div className="divide-y divide-solid">
            {/* perulangan waktu */}
            {weather.upcomingHour
              ? weather.upcomingHour.map((item) => {
                  const Icon = weatherCodeConversion(
                    item ? item.weather : 0,
                    item.time
                  ).icon;
                  return (
        ...
        <div className="col-span-1 h-full space-y-1 border border-neutral-200 p-4 rounded-md">
          <div className="font-semibold text-lg">Curah hujan</div>
          <Graph data={weather.precipitation || []} />
        </div>

        <div className="col-span-1 h-full space-y-1 border border-neutral-200 p-4 rounded-md">
          <div className="font-semibold text-lg">
            Perkiraan beberapa hari kedepan
          </div>
          <div className="divide-y divide-solid">
            {weather.upcomingDays
              ? weather.upcomingDays.map((item, i) => {
                  const Icon = weatherCodeConversion(item.weather, 12).icon;
                  return (
                    <div className="py-2">
            ...
            {/* <div className="py-2">
              <div className="flex justify-between items-center">
                <div className="">
                  <div className="font-bold">Lusa</div>
                  <div className="font-light text-sm">Minggu, 29 Nov</div>
                </div>
                <div className="flex items-center text-right gap-1">
                  <div>
                    <div className="font-bold text-xl flex items-center">
                    ...
                    <div className="text-sm font-light">
                      Curah 0<span className="text-xs">mm</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="col-span-2 text-sm italic text-neutral-800">
          <div className="">
            Data prediksi cuaca diperoleh dari Badan Meteorologi, Klimatologi,
            dan Geofisika
            {weather.metadata
...
function Graph({ data }) {
  // Data harus berbentuk seperti ini (bukan array biasa)
  const graphData = [
    {
      id: "Suhu",
      color: "hsl(200, 70%, 50%)",
...
// fungsi unutk menampilkan jam dinamis
function Clock() {
